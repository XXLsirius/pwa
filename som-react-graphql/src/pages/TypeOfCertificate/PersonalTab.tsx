...
const PersonalTab: FC<PersonalTabProps> = ({ title }) => {
  ...
  return (
    <Card title={title} hasPlus={true} plusTarget="#toc-personal-modal" onPlusClick={onPlusClick} content={
          ...
          <tr key={i}>
            ...
            <td className="text-right">
              <button
                ...
                data-toggle="modal"
                data-target="#toc-personal-modal">
